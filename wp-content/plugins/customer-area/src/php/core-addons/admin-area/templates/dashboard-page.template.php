...
<div class="wrap cuar-dashboard-screen">
    ...
    <ul class="cuar-related-actions">
        ...
        <li>
            <a href="<?php cuar_site_url('/documentation/introduction');
			?>" class="button button-primary" target="_blank"><?php _e('Documentation', 'cuar'); ?></a>
        </li>
        <li>
            <a href="<?php echo cuar_site_url('/support'); ?>" class="button button-primary"
			   target="_blank"><?php _e('Support', 'cuar'); ?></a>
        </li>
        <li>
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo cuar_site_url(); ?>"
            data-text="<?php echo esc_url('An open-source (free) plugin for #WordPress to share private content, easily.', 'cuar'); ?>" data-via="WPCustomerArea" data-size="large" data-hashtags="WPCA">Tweet</a>
