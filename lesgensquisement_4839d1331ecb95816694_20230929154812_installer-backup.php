...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'lesgensquisement_4839d1331ecb95816694_20230929154812_archive.zip';
        const ARCHIVE_SIZE       = '123047435';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4839d13-29154812';
        const SECONDARY_PACKAGE_HASH = 'b401475-29154812';
        const VERSION            = '1.5.6';
